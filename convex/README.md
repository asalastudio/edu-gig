...
5. **Seed data (dev only):** see [`docs/DEMO_SEED_CREDENTIALS.md`](../docs/DEMO_SEED_CREDENTIALS.md) — set `ALLOW_DEMO_SEED=true` and `DEMO_SEED_SECRET` on dev Convex, run `seed:populate`, then create matching Clerk dev users.
