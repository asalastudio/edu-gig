...
export const BETA_FOUNDING_EDUCATORS = [
    {
        ...
        bio: "Twelve years supporting diverse learners across K–8. I specialize in literacy interventions, MTSS cycles, and IEP compliance coaching for campus teams.",
        yearsExperience: 12,
    ...
    },
    {
        ...
        bio: "Passionate about making mathematics accessible to multilingual learners. High-impact tutoring, algebra readiness blocks, and curriculum design for grades 9–12.",
        yearsExperience: 8,
