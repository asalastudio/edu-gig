...
it('explains real draft, credential review and agreement coordination tasks',()=>{render(<Help/>);expect(screen.getByText(/preview draft.*import/i)).toBeInTheDocument();expect(screen.getByText(/credentials reviewed.*background/i)).toBeInTheDocument();});
